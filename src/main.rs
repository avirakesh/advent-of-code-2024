...
fn main() {
    ...
    match args.day {
        ...
        19 => day19::main(args.part, args.input_file),
        20 => day20::main(args.part, args.input_file),
        21 => day21::main(args.part, args.input_file),
        22 => day22::main(args.part, args.input_file),
        23 => day23::main(args.part, args.input_file),
        _ => panic!("Invalid Day :("),
    }
}
